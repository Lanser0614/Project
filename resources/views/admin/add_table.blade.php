    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="{{ route('tableStore') }}" method="POST" enctype="multipart/form-data">
                @csrf
              <div class="card-body" style="display: block;">
                <div class="form-group">
                  <label for="inputName">Xona raqami</label>
                  <input type="number" id="inputName" name="number_room" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="inputName">Gurux raqami</label>
                    <input type="text" id="inputName" name="group_number" class="form-control" required>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <input type="time" name="science_time" id="inputClientCompany" class="form-control" required>
                </div>
